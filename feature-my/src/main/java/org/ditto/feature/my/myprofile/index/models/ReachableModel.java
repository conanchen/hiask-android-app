 ...
 */
@EpoxyModelClass
public abstract class ReachableModel extends EpoxyModelWithHolder<ReachableModel.Holder> {
    @EpoxyAttribute
    String detail;
    ...
    protected int getDefaultLayout() {
        return R.layout.myprofie_reachable_view;
    }


    public static class Holder extends EpoxyHolder {

        @BindView(R2.id.reachable_desc)
        TextView detail;
