...
@Route(path = "/feature_my/ConsultingpriceEditActivity")
public class ConsultingpriceEditActivity extends BaseActivity
        implements ConsultingpriceController.AdapterCallbacks {
    ...
    ConsultingpriceEditViewModel viewModel;
    ...
    private final ConsultingpriceController controller = new ConsultingpriceController(this, recycledViewPool);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.myprofile_activity_consultingprice_edit);
...
//        recycledViewPool.setMaxRecycledViews(R.layout.model_carousel_group, Integer.MAX_VALUE);
    ...
    private void setupController() {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(ConsultingpriceEditViewModel.class);
        Map<String, Object> datas = new HashMap<>();
        datas.put(Constants.DATA1, new ArrayList<Gift>());
        controller.setData((List<Gift>) datas.get(Constants.DATA1));

        viewModel.getLiveGifts().observe(this, gifts -> {
            datas.put(Constants.DATA1, gifts);
            controller.setData((List<Gift>) datas.get(Constants.DATA1));
        });
    }
