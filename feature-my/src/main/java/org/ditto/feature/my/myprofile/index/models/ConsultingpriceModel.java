 ...
 */
@EpoxyModelClass
public abstract  class ConsultingpriceModel extends EpoxyModelWithHolder<ConsultingpriceModel.Holder> {
    @EpoxyAttribute
    int feeValue;
    ...
    public void bind(Holder holder) {
        holder.value.setText(String.valueOf(feeValue));
    ...
    protected int getDefaultLayout() {
        return R.layout.myprofie_consultingfee_view;
    }
