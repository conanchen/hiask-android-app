...
@Entity()
public class BuyanswerMessage implements Parcelable {
    ...
    public BuyanswerMessage() {
    }

    @Ignore
    public BuyanswerMessage(String uuid, String buyanswerUuid, int floor, String contentType, String content, String creatorUuid, String toUserUuid, long created) {
        this.uuid = uuid;
    ...
    public static final Creator<BuyanswerMessage> CREATOR = new Creator<BuyanswerMessage>() {
        @Override
        public BuyanswerMessage createFromParcel(Parcel in) {
            return new BuyanswerMessage(in);
        }

        @Override
        public BuyanswerMessage[] newArray(int size) {
            return new BuyanswerMessage[size];
        }
    };
    ...
    protected BuyanswerMessage(Parcel in) {
    ...
    public static final class Builder {
        ...
        public BuyanswerMessage build() {
            ...
            BuyanswerMessage buyanswerMessage = new
                    BuyanswerMessage(uuid, buyanswerUuid, floor, contentType,
                    content, creatorUuid, toUserUuid, created);
            return buyanswerMessage;
        }
