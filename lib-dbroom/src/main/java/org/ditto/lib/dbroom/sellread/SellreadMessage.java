...
@Entity()
public class SellreadMessage implements Parcelable {
    private final static Gson gson = new GsonBuilder().create();

    @PrimaryKey
    public String uuid;

    public String sellreadUuid;
    public int floor;
    ...
    public SellreadMessage() {
    }

    @Ignore
    public SellreadMessage(String uuid, String sellreadUuid, int floor, String contentType, String content, String creatorUuid, String toUserUuid, long created) {
        this.uuid = uuid;
        this.sellreadUuid = sellreadUuid;
        this.floor = floor;
    ...
    public static final Creator<SellreadMessage> CREATOR = new Creator<SellreadMessage>() {
        @Override
        public SellreadMessage createFromParcel(Parcel in) {
            return new SellreadMessage(in);
        }

        @Override
        public SellreadMessage[] newArray(int size) {
            return new SellreadMessage[size];
        }
    };
    ...
    protected SellreadMessage(Parcel in) {
    ...
    public static final class Builder {
        ...
        public Builder setSellreadUuid(String sellreadUuid) {
            this.sellreadUuid = sellreadUuid;
            return this;
        }
        ...
        public SellreadMessage build() {
            ...
            if (Strings.isNullOrEmpty(sellreadUuid)) {
            ...
            SellreadMessage buyanswerContent = new
                    SellreadMessage(  uuid,   sellreadUuid,   floor,   contentType,
                    content,   creatorUuid,   toUserUuid,   created) ;
