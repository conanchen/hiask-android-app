...
public class BuyreadContent implements Parcelable {
    ...
    public BuyreadContent() {
    }

    @Ignore
    public BuyreadContent(String buyanswerUuid, String contentUuid, String contentType, String content, long created) {
    ...
    public static final Creator<BuyreadContent> CREATOR = new Creator<BuyreadContent>() {
        @Override
        public BuyreadContent createFromParcel(Parcel in) {
            return new BuyreadContent(in);
        }

        @Override
        public BuyreadContent[] newArray(int size) {
            return new BuyreadContent[size];
        }
    };
    ...
    protected BuyreadContent(Parcel in) {
    ...
    public static final class Builder {
        ...
        public BuyreadContent build() {
            ...
            BuyreadContent buyanswerContent = new BuyreadContent(buyanswerUuid,
