...
@Entity
public class UgroupCommand implements Parcelable {
    @PrimaryKey
    String uuid;
    ...
    @Ignore
    public UgroupCommand(String uuid, long created) {
        this.uuid = uuid;
        this.created = created;
    }

    @Ignore
    public UgroupCommand(UpdateLatestLocation updateLatestLocation) {
    ...
    @Ignore
    public UgroupCommand(UpdateNickname updateNickname) {
        this(UUID.randomUUID().toString(), System.currentTimeMillis());
    ...
    @Ignore
    protected UgroupCommand(Parcel in) {

    }

    public static final Creator<UgroupCommand> CREATOR = new Creator<UgroupCommand>() {
        @Override
        public UgroupCommand createFromParcel(Parcel in) {
            return new UgroupCommand(in);
        }

        @Override
        public UgroupCommand[] newArray(int size) {
            return new UgroupCommand[size];
        }
    };
