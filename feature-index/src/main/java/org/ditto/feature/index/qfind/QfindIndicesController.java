...
public class QfindIndicesController extends TypedEpoxyController<List<IndexParty>> {
    @Override
    ...
    public QfindIndicesController(AdapterCallbacks callbacks, RecycledViewPool recycledViewPool) {
