package org.ditto.feature.index.doctor;
 ...
 * <p/>
 */
public class FragmentDoctorIndices extends BaseFragment implements Injectable, DoctorIndicesController.AdapterCallbacks {

    @Inject
    IndexViewModelFactory viewModelFactory;

    private DoctorIndicesViewModel viewModel;

    private static final int SPAN_COUNT = 1;

    private final RecyclerView.RecycledViewPool recycledViewPool = new RecyclerView.RecycledViewPool();
    private final DoctorIndicesController controller = new DoctorIndicesController(this, recycledViewPool);
    ...
    private void setupController() {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(DoctorIndicesViewModel.class);
    ...
    public static final class Builder {
        ...
        public FragmentDoctorIndices build() {
            ...
            FragmentDoctorIndices fragment = new FragmentDoctorIndices();
