...
import org.ditto.feature.index.doctor.models.ItemIndexDoctorModel_;
...
public class DoctorIndicesController extends TypedEpoxyController<List<IndexParty>> {
    @Override
    ...
    public DoctorIndicesController(AdapterCallbacks callbacks, RecycledViewPool recycledViewPool) {
