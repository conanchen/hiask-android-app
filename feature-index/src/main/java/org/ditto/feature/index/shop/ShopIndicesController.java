...
import org.ditto.feature.index.shop.models.ItemIndexShopModel_;
...
public class ShopIndicesController extends TypedEpoxyController<List<IndexParty>> {
    @Override
    ...
    public ShopIndicesController(AdapterCallbacks callbacks, RecycledViewPool recycledViewPool) {
