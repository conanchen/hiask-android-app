 ...
 * <p/>
 */
public class FragmentFriendIndices extends BaseFragment implements Injectable, FriendIndicesController.AdapterCallbacks {

    @Inject
    IndexViewModelFactory viewModelFactory;

    private FriendIndicesViewModel viewModel;

    private static final int SPAN_COUNT = 1;

    private final RecyclerView.RecycledViewPool recycledViewPool = new RecyclerView.RecycledViewPool();
    private final FriendIndicesController controller = new FriendIndicesController(this, recycledViewPool);
    ...
    private void setupController() {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(FriendIndicesViewModel.class);
        Map<String, Object> datas = new HashMap<>();
        datas.put(Constants.DATA1, new ArrayList<IndexMessage>());

        viewModel.getLiveFriendIndices().observe(this, messages -> {
    ...
    public static final class Builder {
        ...
        public FragmentFriendIndices build() {
            ...
            FragmentFriendIndices fragment = new FragmentFriendIndices();
