...
public class IsrealIndicesController extends TypedEpoxyController<List<IndexMessage>> {
    ...
    public IsrealIndicesController(AdapterCallbacks callbacks, RecycledViewPool recycledViewPool) {
