package org.ditto.feature.index.shop;
 ...
 * <p/>
 */
public class FragmentShopIndices extends BaseFragment implements Injectable, ShopIndicesController.AdapterCallbacks {

    @Inject
    IndexViewModelFactory viewModelFactory;

    private ShopIndicesViewModel viewModel;

    private static final int SPAN_COUNT = 1;

    private final RecyclerView.RecycledViewPool recycledViewPool = new RecyclerView.RecycledViewPool();
    private final ShopIndicesController controller = new ShopIndicesController(this, recycledViewPool);
    ...
    private void setupController() {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(ShopIndicesViewModel.class);
    ...
    public static final class Builder {
        ...
        public FragmentShopIndices build() {
            ...
            FragmentShopIndices fragment = new FragmentShopIndices();
