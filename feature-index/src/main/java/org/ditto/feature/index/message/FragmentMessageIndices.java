 ...
 * <p/>
 */
public class FragmentMessageIndices extends BaseFragment implements Injectable, MessageIndicesController.AdapterCallbacks {

    @Inject
    IndexViewModelFactory viewModelFactory;

    private MessageIndicesViewModel viewModel;

    private static final int SPAN_COUNT = 1;

    private final RecyclerView.RecycledViewPool recycledViewPool = new RecyclerView.RecycledViewPool();
    private final MessageIndicesController controller = new MessageIndicesController(this, recycledViewPool);
    ...
    private void setupController() {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(MessageIndicesViewModel.class);
    ...
    public static final class Builder {
        ...
        public FragmentMessageIndices build() {
            String missing = "";
            if (title == null) {
                missing += " title";
            }
            ...
            FragmentMessageIndices fragment = new FragmentMessageIndices();
