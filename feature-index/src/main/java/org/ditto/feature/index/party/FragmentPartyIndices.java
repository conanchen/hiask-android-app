package org.ditto.feature.index.party;
 ...
 * <p/>
 */
public class FragmentPartyIndices extends BaseFragment implements Injectable, PartyIndicesController.AdapterCallbacks {

    @Inject
    IndexViewModelFactory viewModelFactory;

    private PartyIndicesViewModel viewModel;
    ...
    private final PartyIndicesController controller = new PartyIndicesController(this, recycledViewPool);
    ...
    private void setupController() {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(PartyIndicesViewModel.class);
    ...
    public static final class Builder {
        ...
        public FragmentPartyIndices build() {
            ...
            FragmentPartyIndices fragment = new FragmentPartyIndices();
