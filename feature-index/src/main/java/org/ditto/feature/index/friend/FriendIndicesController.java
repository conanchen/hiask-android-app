...
public class FriendIndicesController extends TypedEpoxyController<List<IndexParty>> {
    @Override
    ...
    public FriendIndicesController(AdapterCallbacks callbacks, RecycledViewPool recycledViewPool) {
