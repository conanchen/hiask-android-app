package org.ditto.feature.index.qfind;
 ...
 * <p/>
 */
public class FragmentQfindIndices extends BaseFragment implements Injectable, QfindIndicesController.AdapterCallbacks {

    @Inject
    IndexViewModelFactory viewModelFactory;

    private QfindIndicesViewModel viewModel;

    private static final int SPAN_COUNT = 1;

    private final RecyclerView.RecycledViewPool recycledViewPool = new RecyclerView.RecycledViewPool();
    private final QfindIndicesController controller = new QfindIndicesController(this, recycledViewPool);
    ...
    private void setupController() {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(QfindIndicesViewModel.class);
    ...
    public static final class Builder {
        ...
        public FragmentQfindIndices build() {
            ...
            FragmentQfindIndices fragment = new FragmentQfindIndices();
