...
import org.ditto.feature.index.party.models.ItemIndexPartyModel_;
...
public class PartyIndicesController extends TypedEpoxyController<List<IndexParty>> {
    @Override
    ...
    public PartyIndicesController(AdapterCallbacks callbacks, RecycledViewPool recycledViewPool) {
