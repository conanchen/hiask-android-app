 ...
 */
@EpoxyModelClass
public abstract    class ItemCreateCommandSellreadModel extends EpoxyModelWithHolder<ItemCreateCommandSellreadModel.ReachableHolder> {
    @EpoxyAttribute
    String title;
    @EpoxyAttribute
    String detail;
    ...
    @Override
    public void bind(ItemCreateCommandSellreadModel.ReachableHolder holder) {
    ...
    @Override
    public void unbind(ItemCreateCommandSellreadModel.ReachableHolder holder) {
    ...
    protected int getDefaultLayout() {
        return R.layout.item_createcommand_sellread;
    }
