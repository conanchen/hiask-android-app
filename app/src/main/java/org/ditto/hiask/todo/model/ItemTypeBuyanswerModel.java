 ...
 */
@EpoxyModelClass
public abstract class ItemTypeBuyanswerModel extends EpoxyModelWithHolder<ItemTypeBuyanswerModel.ReachableHolder> {
    @EpoxyAttribute
    String title;
    @EpoxyAttribute
    String detail;
    ...
    @Override
    public void bind(ItemTypeBuyanswerModel.ReachableHolder holder) {
    ...
    @Override
    public void unbind(ItemTypeBuyanswerModel.ReachableHolder holder) {
