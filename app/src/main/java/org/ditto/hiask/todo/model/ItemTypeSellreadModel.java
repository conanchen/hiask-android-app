 ...
 */
@EpoxyModelClass
public abstract    class ItemTypeSellreadModel extends EpoxyModelWithHolder<ItemTypeSellreadModel.ReachableHolder> {
    @EpoxyAttribute
    String title;
    @EpoxyAttribute
    String detail;
    ...
    @Override
    public void bind(ItemTypeSellreadModel.ReachableHolder holder) {
    ...
    @Override
    public void unbind(ItemTypeSellreadModel.ReachableHolder holder) {
