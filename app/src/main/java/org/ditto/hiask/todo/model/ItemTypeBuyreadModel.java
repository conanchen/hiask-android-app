 ...
 */
@EpoxyModelClass
public abstract    class ItemTypeBuyreadModel extends EpoxyModelWithHolder<ItemTypeBuyreadModel.ReachableHolder> {
    @EpoxyAttribute
    String title;
    @EpoxyAttribute
    String detail;
    ...
    @Override
    public void bind(ItemTypeBuyreadModel.ReachableHolder holder) {
    ...
    @Override
    public void unbind(ItemTypeBuyreadModel.ReachableHolder holder) {
