 ...
 */
@EpoxyModelClass
public abstract    class ItemNonpublishedSellreadModel extends EpoxyModelWithHolder<ItemNonpublishedSellreadModel.ReachableHolder> {
    @EpoxyAttribute
    String title;
    @EpoxyAttribute
    String detail;
    ...
    @Override
    public void bind(ItemNonpublishedSellreadModel.ReachableHolder holder) {
    ...
    @Override
    public void unbind(ItemNonpublishedSellreadModel.ReachableHolder holder) {
    ...
    protected int getDefaultLayout() {
        return R.layout.item_choose_sellread;
    }
