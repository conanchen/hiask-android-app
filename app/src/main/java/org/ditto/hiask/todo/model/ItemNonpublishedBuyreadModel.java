 ...
 */
@EpoxyModelClass
public abstract    class ItemNonpublishedBuyreadModel extends EpoxyModelWithHolder<ItemNonpublishedBuyreadModel.ReachableHolder> {
    @EpoxyAttribute
    String title;
    @EpoxyAttribute
    String detail;
    ...
    @Override
    public void bind(ItemNonpublishedBuyreadModel.ReachableHolder holder) {
    ...
    @Override
    public void unbind(ItemNonpublishedBuyreadModel.ReachableHolder holder) {
    ...
    protected int getDefaultLayout() {
        return R.layout.item_choose_buyread;
    }
