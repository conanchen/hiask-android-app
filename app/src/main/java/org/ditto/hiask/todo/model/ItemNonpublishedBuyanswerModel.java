 ...
 */
@EpoxyModelClass
public abstract class ItemNonpublishedBuyanswerModel extends EpoxyModelWithHolder<ItemNonpublishedBuyanswerModel.ReachableHolder> {
    @EpoxyAttribute
    String title;
    @EpoxyAttribute
    String detail;
    ...
    @Override
    public void bind(ItemNonpublishedBuyanswerModel.ReachableHolder holder) {
    ...
    @Override
    public void unbind(ItemNonpublishedBuyanswerModel.ReachableHolder holder) {
    ...
    protected int getDefaultLayout() {
        return R.layout.item_choose_buyanswer;
    }
