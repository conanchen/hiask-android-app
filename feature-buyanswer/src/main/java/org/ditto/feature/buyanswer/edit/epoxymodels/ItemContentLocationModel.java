 ...
 */
@EpoxyModelClass
public abstract class ItemContentLocationModel extends EpoxyModelWithHolder<ItemContentLocationModel.QuestionContentTextHolder> {
    ...
    @Override
    public void bind(ItemContentLocationModel.QuestionContentTextHolder holder) {
        holder.questionContentText.setText(String.format(detail));
        holder.questionContentText.setOnClickListener(clickListener);
    }

    @Override
    public void unbind(ItemContentLocationModel.QuestionContentTextHolder holder) {
    ...
    protected int getDefaultLayout() {
        return R.layout.buyanswer_item_content_location_model;
    }
