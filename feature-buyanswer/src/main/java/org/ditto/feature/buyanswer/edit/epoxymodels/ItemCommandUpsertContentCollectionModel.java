 ...
 */
@EpoxyModelClass
public abstract class ItemCommandUpsertContentCollectionModel extends EpoxyModelWithHolder<ItemCommandUpsertContentCollectionModel.QuestionContentTextHolder> {
    ...
    @Override
    public void bind(ItemCommandUpsertContentCollectionModel.QuestionContentTextHolder holder) {
        holder.questionContentText.setText(String.format(detail));
        holder.questionContentText.setOnClickListener(clickListener);
    }

    @Override
    public void unbind(ItemCommandUpsertContentCollectionModel.QuestionContentTextHolder holder) {
    ...
    protected int getDefaultLayout() {
        return R.layout.buyanswer_item_content_collection_model;
    }
