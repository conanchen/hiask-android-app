 ...
 */
@EpoxyModelClass
public abstract class ItemTime2finishModel extends EpoxyModelWithHolder<ItemTime2finishModel.Holder> {
    @EpoxyAttribute
    long time;
    ...
    protected int getDefaultLayout() {
        return R.layout.buyanswer_item_time2finish_model;
    }

    @Override
    public void bind(Holder holder) {
        holder.questionTime.setText(String.format("设定%d分钟内回答问题",time));
