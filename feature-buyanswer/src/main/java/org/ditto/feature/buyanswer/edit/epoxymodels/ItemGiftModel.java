 ...
 */
@EpoxyModelClass
public abstract class ItemGiftModel extends EpoxyModelWithHolder<ItemGiftModel.Holder> {
    ...
    protected int getDefaultLayout() {
        return R.layout.buyanswer_item_gift_model;
    }
    ...
    public void bind(Holder holder) {
        ...
        holder.giftDetail.setText(String.format("设定[%s]为问题赏金礼物,你真是一个吝啬/爽快/壕爽的人", name));
