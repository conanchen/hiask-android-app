 ...
 */
@EpoxyModelClass
public abstract class ItemContentVideoModel extends EpoxyModelWithHolder<ItemContentVideoModel.QuestionContentTextHolder> {
    ...
    @Override
    public void bind(ItemContentVideoModel.QuestionContentTextHolder holder) {
        holder.questionContentText.setText(String.format(detail));
        holder.questionContentText.setOnClickListener(clickListener);
    }

    @Override
    public void unbind(ItemContentVideoModel.QuestionContentTextHolder holder) {
    ...
    protected int getDefaultLayout() {
        return R.layout.buyanswer_item_content_video_model;
    }
