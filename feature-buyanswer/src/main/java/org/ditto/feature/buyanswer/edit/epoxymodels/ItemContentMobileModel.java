 ...
 */
@EpoxyModelClass
public abstract class ItemContentMobileModel extends EpoxyModelWithHolder<ItemContentMobileModel.QuestionContentTextHolder> {
    ...
    @Override
    public void bind(ItemContentMobileModel.QuestionContentTextHolder holder) {
        holder.questionContentText.setText(String.format(detail));
        holder.questionContentText.setOnClickListener(clickListener);
    }

    @Override
    public void unbind(ItemContentMobileModel.QuestionContentTextHolder holder) {
    ...
    protected int getDefaultLayout() {
        return R.layout.buyanswer_item_content_mobile_model;
    }
