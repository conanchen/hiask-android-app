 ...
 */
@EpoxyModelClass
public abstract class ItemCommandSetTime2finishModel extends EpoxyModelWithHolder<ItemCommandSetTime2finishModel.Holder> {
    @EpoxyAttribute
    long time;
    ...
    protected int getDefaultLayout() {
        return R.layout.buyanswer_item_command_settime2finish_model;
    }

    @Override
    public void bind(Holder holder) {
        holder.questionTime.setText(String.format("准备：设定%d分钟内回答问题",time));
