 ...
 */
@EpoxyModelClass
public abstract class ItemCommandUpsertContentAudioModel extends EpoxyModelWithHolder<ItemCommandUpsertContentAudioModel.Holder> {
    ...
    protected int getDefaultLayout() {
        return R.layout.buyanswer_item_content_audio_model;
    }
