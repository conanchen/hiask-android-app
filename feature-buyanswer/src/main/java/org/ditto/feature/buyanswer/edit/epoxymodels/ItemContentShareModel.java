 ...
 */
@EpoxyModelClass
public abstract class ItemContentShareModel extends EpoxyModelWithHolder<ItemContentShareModel.QuestionContentTextHolder> {
    ...
    @Override
    public void bind(ItemContentShareModel.QuestionContentTextHolder holder) {
        holder.questionContentText.setText(String.format(detail));
        holder.questionContentText.setOnClickListener(clickListener);
    }

    @Override
    public void unbind(ItemContentShareModel.QuestionContentTextHolder holder) {
    ...
    protected int getDefaultLayout() {
        return R.layout.buyanswer_item_content_share_model;
    }
