 ...
 */
@EpoxyModelClass
public abstract class ItemContentCollectionModel extends EpoxyModelWithHolder<ItemContentCollectionModel.QuestionContentTextHolder> {
    ...
    @Override
    public void bind(ItemContentCollectionModel.QuestionContentTextHolder holder) {
        holder.questionContentText.setText(String.format(detail));
        holder.questionContentText.setOnClickListener(clickListener);
    }

    @Override
    public void unbind(ItemContentCollectionModel.QuestionContentTextHolder holder) {
